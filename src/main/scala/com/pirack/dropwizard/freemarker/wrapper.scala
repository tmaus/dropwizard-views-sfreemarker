...
/**
  * Created by tmaus on 28/8/16.
  *
  * @see https://github.com/btd/scala-freemarker/blob/master/src/main/scala/wrappers.scala
  */


class ScalaObjectWrapper(version:Version) extends ObjectWrapper {
